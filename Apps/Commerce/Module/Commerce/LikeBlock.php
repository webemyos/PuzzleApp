 ...
 * Module StatBlock
 * */
 class LikeBlock extends JHomBlock implements IJhomBlock
 {
	  ...
	  function Show($all=true)
	  {
           ...
           function GetTool()
           {
               ...
               //Tab veriticale
               $vTab = new VTab("vTLike"); 
               $vTab->CssClass = "content";
               $vTab->SelectedIndex = 99;
               $vTab->AddTab($this->Core->GetCode("EeProjet.TitleTabLike"), $this->GetTabLike($commerce), false);
    ...
    function GetTabLike()
    {
        $modele = new JModele(EeCommerce::$Directory . "/Blocks/CommerceBlock/View/GetTabLike.tpl", $this->Core); 
       
        $like = new EeCommerceLike($this->Core);
        $likes = $like->GetAll();
