...
class Message extends Application
{
	 ...
	 * */
	 ...
	 function Run()
	 {
        ...
        {
            $messageBlock = new MessageBlock($this->Core);
            echo $messageBlock->ShowSendMessage( Request::GetPost('AppName'),
        ...
        public function LoadInBox($app = "", $show = true)
        {
            ...
            if($show)
            {
                echo $messageBlock->LoadInBox($app);
            }
            else
            {
                return $messageBlock->LoadInBox($app);
            }
        }
        ...
        public function ShowDetail()
        {
           ...
           $messageBlock = new MessageBlock($this->Core);
           echo $messageBlock->ShowDetail($messageId);
        }
        ...
        public function ShowDetailSend()
        {
           ...
           $messageBlock = new MessageBlock($this->Core);
           echo $messageBlock->ShowDetailSend($messageId);
        }
