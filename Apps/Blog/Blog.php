...
class Blog extends Application
{
    ...
    /*
     * Load Category of a blog
     */
    function GetTabCategory()
    {
        $blog = new BlogBlog($this->Core);
        $blog->GetById(Request::GetPost("Params"));
        
        $blogController = new BlogController($this->Core);
        echo $blogController->GetTabCategory($blog, Request::GetPost("showAll"));
    }
    
    /*
     * Load Lecteur of a blog
     */
    function GetTabLecteur()
    {
        $blog = new BlogBlog($this->Core);
        $blog->GetById(Request::GetPost("Params"));
        
        $blogController = new BlogController($this->Core);
        echo $blogController->GetTabLecteur($blog);
    }
    
    /*
     * Load Article of a blog
     */
    function GetTabArticle()
    {
        ...
        $blogController = new BlogController($this->Core);
        echo $blogController->GetTabArticles($blog, false);
    }
    ...
    function ShowAddCategory()
    {
        ...
        echo $categoryController->ShowAddCategory(Request::GetPost("blogId"), Request::GetPost("idEntite"));
    }
