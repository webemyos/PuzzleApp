    ...
    */
    ...
    BlogAction.LoadMyBlog = function()
    {
       var data = "Class=Blog&Methode=LoadMyBlog&App=Blog";
           ...
           EntityGrid.Initialise('gdBlog');
           //setTimeout("EntityGrid.Init('gdBlog')", 1000);
    };
    ...
    BlogAction.LoadBlog = function(blogId)
    {
      var data = "Class=Blog&Methode=LoadBlog&App=Blog";
          ...
          //Charge les image du blog
           ...
           EntityGrid.Initialise('gdLecteur');
           EntityGrid.Initialise('gdArticle');
    
    };

    BlogAction.EditCategory = function(categoryId)
    {
        BlogAction.ShowAddCategory("", categoryId);
    };
    ...
    {
       var data = "Class=Blog&Methode=GetTabCategory&App=Blog";
           data += "&blogId=" + blogId;
           data += "&showAll=true";
    ...
    {
       var data = "Class=Blog&Methode=GetTabArticle&App=Blog";
           data += "&blogId=" + blogId;

           Dashboard.LoadControl("gdArticle", data, "" , "table", "Blog");
     ...
     * @type type
     */
    BlogAction.EditPropertyArticle = function(articleId, blogId)
    {
