...
<div class='row' class='borderBottom' >
    <div class='headerHome' >
        <h1>Besoin d'une solution pour votre prochain site internet ?<br/>Pourquoi pas PuzzleApp ? </h1>
    </div>
    <div>
        <h2 class='fa fa-puzzle-piece fa-2x borderBottom'>&nbsp;PuzzleApp c'est :</h2>
    </div>
    <div class='col-md-5'>
        <h3 class='fa fa-gears fa-2x'>&nbsp;Un framework simple </h3>
            <ul>
    ...
    <div class='col-md-5'>
        ...
        <ul>
            <li>Pour gérer vos pages.</li>
            <li>Pour faires des enquêtes.</li>
            <li>Pour blogger.</li>
            <li>Pour envoyer et suivre les emails.</li>
...
<div class='row'>
    ...
    <div class='col-md-12 borderTop'>
      ...
      <div class='col-md-4'>
          ...
          <button class='btn btn-success'>Les tutoriels</button>
      </div>
    </div>
