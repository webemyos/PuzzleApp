...
use Core\Modele\ModeleManager;
use Core\Modele\FunctionManager;
...
class Modele
{
    ...
    public function __construct($template, $core = "")
    {
        ...
        $this->Template = ModeleManager::Find($template);
    ...
    */
    ...
    public function Render()
    {
        ...
        foreach($this->Elements as $element)
        {
            ...
            else if(get_class($element)== "Core\Modele\ElementModele")
            {
                $html = ModeleManager::ReplaceElement($html, $element);
            }
            //Remplacement du champ par la propriete de l'objet
            else if(get_class($element)== "Core\Modele\ContentModele")
            {
                $html = ModeleManager::ReplaceContent($html, $element);
            }
            else
            {
