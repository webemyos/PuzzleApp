...
class ModeleManager 
{
    ...
    public static function ReplaceElement($html, $element)
    {
        ...
        {
            $html =  ModeleManager::LoadCollections($html, $key, $value);
        }
        else
        {
    ...
    public static function LoadCollections($html, $key, $element)
    {
        ...
        if(count($element) > 0)
        {
            ...
            foreach($element as $elm)
            {
                ...
                $newLine = ModeleManager::LoadElementProperty($elm, $html, $newLine );
                $newLine = ModeleManager::LoadFunction($elm, $html, $newLine );
